...
$product_id = $_GET['pro_id'];
	...
	$get_pro = "select * from products_books where product_id='$product_id'";
	...
	echo "<div class='col-sm-4'>"; 
            ...
            echo "<img src='$pro_image' width='500' height='300' />";
            echo "<h2>$ $pro_price </h2>";
			echo "<p>$pro_title</p>";
			echo "<p style='font-size:10'>$pro_desc</p>";
			echo "<a href='books.php' style='float:left text-decoration: none color:black'; class='btn btn-default add-to-cart'>Go Back</a>";
