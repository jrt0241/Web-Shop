...
function validfname()
{
    ...
    {
        document.getElementById("fnerror").innerHTML = "<font color=red>First Name doesnot allow Digits or any Special characters</font>";
        return false;
    } else
    {
...
function validlname()
{
    ...
    {
        document.getElementById("lnerror").innerHTML = "<font color=red>Last Name doesnot allow Digits or any Special characters</font>";
        return false;
    } else
    {
                        ...
                        <div class="signup-form"><!--sign up form-->
                            ...
                            <form method="post" action="registerdb.php" name="form" onsubmit="return finalValidation()">
                                <table cellspacing=20>
                                    <tr><td>FirstName:</td> <td><input type="text" name="FirstName" placeholder="Enter your FirstName" required maxlength="40" size="50" id="FirstName" onblur="return validfname()"></td><td><span id="fnerror"></span></td></tr>
                                    <tr><td>LastName:</td><td><input type="text" name="LastName" placeholder="Enter your LastName" required maxlength="40"  id="LastName" onblur="return validlname()"></td><td><span id="lnerror"></span></td></tr>
